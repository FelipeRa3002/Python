...
def Apresentacao():
       ...
       try:
            ...
            x= 1 if system("start https://www.youtube.com/watch?v=9dK6SsWQFfY") == True else 2
            ...
            try:
              ...
              x= 1 if system("xdg-open https://www.youtube.com/watch?v=9dK6SsWQFfY") == True else 2
              if x == 2:
                  sleep(40)
                  exemplo.chamarJanela()
            except:
               #sistema operacional macOS
               x= 1 if system("open https://www.youtube.com/watch?v=9dK6SsWQFfY") == True else 2
               if x == 2:
                  sleep(40)
                  exemplo.chamarJanela()
       else:
